...
Public Class frmImageWebCam
    ...
    Private Sub frmImageWebCam_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
    ...
    Private Sub frmImageWebCam_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadDeviceList()
